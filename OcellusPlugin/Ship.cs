...
class Ship
{
    ...
    private static void addHardpoint(string slotSize, int slotPos, Dictionary<string, dynamic> currModule, ref Components shipObj)
    {
        Dictionary<string, Hardpoint> weaponMap = new Dictionary<string, Hardpoint>
        {
            ...
            { "hpt_multicannon_fixed_large", new Hardpoint { @class=3, rating="A", group="Multi-cannon", mount="Fixed" } },
            { "hpt_multicannon_fixed_huge", new Hardpoint { @class=4, rating="A", group="Multi-cannon", mount="Fixed" } },
            ...
            { "hpt_multicannon_gimbal_large", new Hardpoint { @class=3, rating="A", group="Multi-cannon", mount="Gimballed" } },
            { "hpt_multicannon_gimbal_huge", new Hardpoint { @class=4, rating="A", group="Multi-cannon", mount="Gimballed" } },
            ...
            { "hpt_pulselaserburst_fixed_huge", new Hardpoint { @class=4, rating="E", group="Burst Laser", mount="Fixed" } },
            ...
            { "hpt_pulselaserburst_gimbal_huge", new Hardpoint { @class=4, rating="E", group="Burst Laser", mount="Gimballed" } },
